...
class PciDeviceMatchTestCase(base.TestCase):
    def setUp(self):
...
class PciDeviceAddressParserTestCase(base.TestCase):
...
class GetFunctionByIfnameTestCase(base.TestCase):
...
class IsPhysicalFunctionTestCase(base.TestCase):
...
class GetIfnameByPciAddressTestCase(base.TestCase):
...
class GetMacByPciAddressTestCase(base.TestCase):
    def setUp(self):
...
class GetVfNumByPciAddressTestCase(base.TestCase):
