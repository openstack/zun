...
class PciPassthroughFilter(filters.BaseHostFilter):
    ...
    Filter that schedules containers on a host if the host has devices
    to meet the device requests in the 'extra_specs'.
    ...
    and container requests PCI devices via PCI requests, like::
