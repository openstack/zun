...
cyborg_group = cfg.OptGroup(
    name='cyborg_client',
    title='Cyborg Service Options',
    help="Configuration options for connecting to the cyborg API service")
...
ALL_OPTS = (cyborg_client_opts + common_security_opts)


def register_opts(conf):
    conf.register_group(cyborg_group)
    conf.register_opts(ALL_OPTS, group=cyborg_group)


def list_opts():
    return {cyborg_group: ALL_OPTS}
